...
Go to **Builds** -> **Builds**. Click the appropriate Build. In the
tab **Configuration** you find the **Triggers** section.
Copy the URL statet in **Github webhook URL**. This URL to be used
