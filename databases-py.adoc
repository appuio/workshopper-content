...
{% if PARKSMAP_PY %}
{% if GIT_HOST == "github" %}
link:https://github.com/openshift-roadshow/nationalparks-py/blob/master/wsgi.py#L11-L18[]
{% else %}
link:http://{{GITLAB_URL_PREFIX}}.{{ROUTER_ADDRESS}}/{{GITLAB_USER}}/nationalparks-py/blob/{{NATIONALPARKS_VERSION}}/wsgi.py#L11-18[]
{% endif %}
{% else %}
link:http://{{GITLAB_URL_PREFIX}}.{{ROUTER_ADDRESS}}/{{GITLAB_USER}}/nationalparks/blob/{{NATIONALPARKS_VERSION}}/src/main/java/org/openshift/parks/mongo/DBConnection.java#L44-l48[]
{% endif %}
