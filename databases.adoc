...
Type `mongodb` in the search box. Then scroll down till you find the section
"Data Stores". Choose the *MongoDB (Ephemeral)* template, and click it.  
...
though, so the ephemeral Mongo template is what you should choose.
